...
//		if (isZh()) {
		icons = new int[] { R.drawable.sfz, R.drawable.beidou,
					R.drawable.loop, R.drawable.fingerprint,
					R.drawable.barcode, R.drawable.m1, R.drawable.rfid15693,
					R.drawable.hx, R.drawable.hk, R.drawable.ic,R.drawable.ic,R.drawable.cpu, R.drawable.barcode,R.drawable.barcode };
//		} else {
	...
	private void showActivity(String str) {
		...
		switch (position) {
			...
			case 5:
				...
				break;
			case 6:
				startActivity(new Intent(this, RFID15693Activity.class));
				break;
			case 7:
				startActivity(new Intent(this, HXUHFActivity.class));
				break;
			case 8:
				startActivity(new Intent(this, HKUHFActivity.class));
				break;
			case 9:
			...
			case 11:
				...
				break;
			case 12:
				startActivity(new Intent(this, SoftDecodingActivity.class));
				break;
			case 13:
				startActivity(new Intent(this, SDLguiActivity.class));
				break;
			default:
				break;
			}
