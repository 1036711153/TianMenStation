...
import com.example.anjian.aty.CircleActivity;
import com.example.anjian.aty.Inspection_UnComment_Activity;
...
public class Uncomment_AnjianSationHXUHFActivity extends BaseUHFActivity {
	...
	class StartHander extends Handler {
		...
		public void handleMessage(Message msg) {
			...
			case INVENTORY_OVER:
				ToastUtil
						.showToast(Uncomment_AnjianSationHXUHFActivity.this, R.string.inventory_over);
				break;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		findViewById(R.id.back_page).setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Uncomment_AnjianSationHXUHFActivity.this.finish();
		...
		findViewById(R.id.next_page).setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent intent=new Intent(Uncomment_AnjianSationHXUHFActivity.this,Inspection_UnComment_Activity.class);
				...
				if (isChecked) {
					if (prgDlg != null) {
						...
						prgDlg = ProgressDialog.show(
								Uncomment_AnjianSationHXUHFActivity.this, "RFID", "链接成功",
								true, false);
					}
					new Thread() {
						@Override
