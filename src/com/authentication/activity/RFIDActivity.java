...
public class RFIDActivity extends BaseActivity implements OnClickListener{
	...
	private Button mBtnGetCardNum,mBtnSendPwd,mBtnValidPwd,mBtnWriteData,mBtnReadData,mBtnUpdate;
	private EditText mEdShowCard,mEdPwdA,mEdPwdB,mBlockNum,mEdWriteData,mReadData,mEdWritePwd;
	...
	private void initView() {
		...
		mAdapterCardType = new ArrayAdapter<String>(this,android.R.layout.simple_spinner_item, cardtype);
	...
	public void onClick(View v) {
		...
		switch(v.getId())
		{
			...
			case R.id.btn_write:
				...
				if (TextUtils.isEmpty(keyA)
						|| TextUtils.isEmpty(keyB) || TextUtils.isEmpty(data))
				{
					ToastUtil.showToast(this,R.string.m1_str_all_not_empty);
					return ;
				}
				if(RegexUtils.isCheckPwd(keyA) 
						&& RegexUtils.isCheckPwd(keyB) && RegexUtils.isCheckWriteData(data))
				{
			...
			case R.id.btn_update:
				...
				if(RegexUtils.isCheckPwd(keyA) 
						&& RegexUtils.isCheckPwd(keyB) && RegexUtils.isCheckPwd(data))
				{
