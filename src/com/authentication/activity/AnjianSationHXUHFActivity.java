...
import com.example.anjian.aty.Anjian_Take_Picture_Activity;
...
public class AnjianSationHXUHFActivity extends BaseUHFActivity {
...
//			}
			...
			case MSG_DISMISS_CONNECT_WAIT_SHOW:
				...
				break;
			case INVENTORY_OVER:
				ToastUtil.showToast(AnjianSationHXUHFActivity.this,
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		findViewById(R.id.back_page).setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				AnjianSationHXUHFActivity.this.finish();
		...
		findViewById(R.id.next_page).setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent intent = new Intent(AnjianSationHXUHFActivity.this,
						Anjian_Take_Picture_Activity.class);
		...
		findViewById(R.id.open_RFID).setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {boolean isChecked=true;
			if (isChecked) {
				if (prgDlg != null) {
					prgDlg.show();
				} else {
					prgDlg = ProgressDialog.show(
							AnjianSationHXUHFActivity.this, "RFID", "链接成功",
							true, false);
				}
				new Thread() {
					@Override
			...
			while (!ISINTENT) {
				...
				if (mNum >= 4) {
					...
					Intent intent = new Intent(
							AnjianSationHXUHFActivity.this,
							Anjian_Take_Picture_Activity.class);
					intent.putExtra(RFID_KEY, mRFID);
					startActivity(intent);
					return;
